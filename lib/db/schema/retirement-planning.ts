...
export const plans = pgTable('plans', {
  ...
  primarySsMonthlyAmount: text('primary_ss_monthly_amount').notNull().default('0'),
  primarySsStartAge: integer('primary_ss_start_age').notNull().default(67),
  spouseSsMonthlyAmount: text('spouse_ss_monthly_amount').notNull().default('0'),
...
export const systemTaxRules = pgTable('system_tax_rules', {
  id: uuid('id').primaryKey().defaultRandom(),
  taxYear: integer('tax_year').notNull().default(2026).unique(),
  country: text('country').notNull().default('US'),
  standardDeductionSingle: text('standard_deduction_single').notNull().default('15750'),
  standardDeductionMfj: text('standard_deduction_mfj').notNull().default('31500'),
  standardDeductionHoH: text('standard_deduction_hoh').notNull().default('23625'),
  standardDeductionMfs: text('standard_deduction_mfs').notNull().default('15750'),
  standardDeduction: text('standard_deduction').notNull().default('15750'),
  ...
  fplAmount: text('fpl_amount').notNull().default('16725'),
