...
export const SETTING_DEFINITIONS: SettingDefinition[] = [
  ...
  { key: 'notifyLargeTransactions', label: 'Transaction Alerts', description: 'Enable push notifications for individual transactions exceeding the threshold', type: 'boolean', group: 'Notifications', defaultValue: NOTIFICATION_DEFAULTS.notifyLargeTransactions },
  { key: 'largeTransactionThreshold', label: 'Transaction Alert Threshold', description: 'Alert threshold value in standard currency units', type: 'number', group: 'Notifications', defaultValue: NOTIFICATION_DEFAULTS.largeTransactionThreshold },
  ...
  { key: 'notifyDailyNetWorthChange', label: 'Notify Daily Net Worth Change', description: 'Enable push notifications when your net worth changes from the previous day', type: 'boolean', group: 'Notifications', defaultValue: NOTIFICATION_DEFAULTS.notifyDailyNetWorthChange },
  { key: 'dailyNetWorthAlertTime', label: 'Daily Net Worth Alert Time', description: 'Time of day to send the daily net worth change alert (HH:MM, 24h format)', type: 'string', group: 'Notifications', defaultValue: NOTIFICATION_DEFAULTS.dailyNetWorthAlertTime },
  ...
  { key: 'redfinApiUrl', label: 'Redfin API Base URL', description: 'Base endpoint URL for Redfin property estimates', type: 'string', group: 'API Keys & Endpoints', defaultValue: API_KEY_DEFAULTS.redfinApiUrl },
