      ...
      <TooltipTrigger asChild>
        {children ? (
          ...
          <button
            type="button"
            className={cn(
              'inline-flex items-center justify-center min-h-11 min-w-11 text-muted-foreground/70 hover:text-foreground transition-colors focus:outline-none focus-visible:ring-1 focus-visible:ring-ring rounded-full -m-2.5 p-0',
              className
            )}
