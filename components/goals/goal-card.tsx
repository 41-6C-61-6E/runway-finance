        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              ...
              {goal.priority > 0 && (
                <span className="text-[10px] font-bold text-muted-foreground px-1.5 py-0.5 rounded bg-muted/50">
                  P{goal.priority}
                </span>
              )}
            </div>
        ...
        {goal.linkedAccountId && (
          <div className="mt-3 pt-3 border-t border-border/50 flex flex-col gap-1 text-xs text-muted-foreground">
            <div className="flex items-center gap-2">
              ...
              {goal.accountName && (
                <span className="text-foreground font-medium ml-auto truncate">{goal.accountName}</span>
              )}
            </div>
