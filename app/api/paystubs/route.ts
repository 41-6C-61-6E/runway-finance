...
export async function GET(request: Request) {
  ...
  const conditions = [eq(paystubs.userId, dataUserId)];
...
export async function DELETE(request: Request) {
  ...
  await db
    .delete(transactions)
    .where(and(eq(transactions.userId, dataUserId), inArray(transactions.paystubId, ids)));

  // Delete the paystubs (cascade deletes line items)
  await db
    .delete(paystubs)
    .where(and(eq(paystubs.userId, dataUserId), inArray(paystubs.id, ids)));
